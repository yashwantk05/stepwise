...
app.post("/api/socratic/chat", requireAuth, async (request, response) => {
  ...
  const tutorId = context?.tutorId === "vaani" ? "vaani" : "saarthi";
  ...
  try {
    ...
    const tutorInstruction =
      tutorId === "vaani"
        ? `You are Vaani, a friendly tutor who gives direct answers clearly.
Provide the correct answer or conclusion directly, then explain it briefly in a way the student can follow.`
